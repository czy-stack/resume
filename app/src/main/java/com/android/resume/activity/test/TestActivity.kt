...
import com.android.resume.databinding.ActivityTestBinding
...
class TestActivity : BaseActivity<TestContract.Presenter,ActivityTestBinding>(), TestContract.View, LifecycleOwner ,
    ...
    override fun initView() {
        ...
        binding.let {
            ...
            it.recView.addItemDecoration(DividerItemDecoration(this, LinearLayoutManager.VERTICAL))
            it.rbTwo.isChecked = true
        }
